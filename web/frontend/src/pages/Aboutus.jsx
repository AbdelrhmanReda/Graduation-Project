...
const Aboutus = () => {
  ...
  <div className=" :container 4xl:mx-auto bg-[#35c8fb] lg:py-30 lg:px-20 md:py-60 md:px-6 py-9 px-4">
    <Navbar />
    
    <div className="flex lg:flex-row flex-col lg:gap-8 sm:gap-10 gap-12">
      <div className="w-full lg:w-6/12">
        <h2 className="w-full font-bold lg:text-4xl text-3xl lg:leading-10 leading-9">
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam a ipsum dignissim ante malesuada ultricies id in erat.
        </h2>
